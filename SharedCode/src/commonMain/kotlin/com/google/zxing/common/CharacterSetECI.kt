...
enum class CharacterSetECI {
    ...
    companion object {
        private val VALUE_TO_ECI: MutableMap<Int, CharacterSetECI> =
            HashMap()
        private val NAME_TO_ECI: MutableMap<String, CharacterSetECI> =
            HashMap()
    ...
    private val otherEncodingNames: Array<String>
     ...
     constructor(value: Int, vararg otherEncodingNames: String) {
        values = intArrayOf(value)
         ...
         this.otherEncodingNames = arrayOf(*otherEncodingNames)
    }
