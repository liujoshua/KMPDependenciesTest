    ...
    fun applyMaskPenaltyRule2(matrix: ByteMatrix): Int {
        ...
        for (y in 0 until height - 1) {
            ...
            for (x in 0 until width - 1) {
                val value = arrayY[x].toInt()
                if (value == arrayY[x + 1].toInt() && value == array[y + 1][x].toInt() && value == array[y + 1][x + 1].toInt()
                ) {
                    penalty++
                }
            }
    ...
    fun applyMaskPenaltyRule3(matrix: ByteMatrix): Int {
        ...
        for (y in 0 until height) {
            for (x in 0 until width) {
                ...
                if (x + 6 < width && arrayY[x].toInt() == 1 && arrayY[x + 1].toInt() == 0 && arrayY[x + 2].toInt() == 1 && arrayY[x + 3].toInt() == 1
                    && arrayY[x + 4].toInt() == 1 && arrayY[x + 5].toInt() == 0 && arrayY[x + 6].toInt() == 1 &&
                    (isWhiteHorizontal(
                        arrayY,
                        x - 4,
                        x
                ...
                if (y + 6 < height && array[y][x].toInt() == 1 && array[y + 1][x].toInt() == 0 && array[y + 2][x].toInt() == 1 && array[y + 3][x].toInt() == 1
                    && array[y + 4][x].toInt() == 1 && array[y + 5][x].toInt() == 0 && array[y + 6][x].toInt() == 1 &&
                    (isWhiteVertical(
                        array,
                        x,
                        y - 4,
    ...
    private fun applyMaskPenaltyRule1Internal(
        ...
        for (i in 0 until iLimit) {
            ...
            for (j in 0 until jLimit) {
                val bit =
                    (if (isHorizontal) array[i][j] else array[j][i]).toInt()
                if (bit == prevBit) {
                    numSameBitCells++
                } else {
