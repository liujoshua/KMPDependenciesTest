...
import com.google.zxing.qrcode.encoder.MaskUtil.getDataMaskBit
...
object MatrixUtil {
    ...
    fun makeVersionInfoBits(
        ...
        val bchCode =
            calculateBCHCode(version.versionNumber, VERSION_INFO_POLY)
    ...
    private fun maybeEmbedPositionAdjustmentPatterns(
        ...
        val coordinates =
            POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE[index]
