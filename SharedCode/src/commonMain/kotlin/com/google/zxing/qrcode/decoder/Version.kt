...
class Version private constructor(
    ...
    vararg ecBlocks: ECBlocks
) {
    private val ecBlocks: Array<out ECBlocks>
    internal val totalCodewords: Int
     ...
     */
    class ECBlocks internal constructor(val eCCodewordsPerBlock: Int, vararg ecBlocks: ECB) {
        val eCBlocks: Array<out ECB> = ecBlocks
     ...
     */
    class ECB internal constructor(val count: Int, val dataCodewords: Int)
    ...
    init {
        ...
        var total = 0
        val ecCodewords = ecBlocks[0].eCCodewordsPerBlock
        val ecbArray = ecBlocks[0].eCBlocks
